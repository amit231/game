...
function Game(props) {
  let [paperClass,setPaperClass]=useState('a');
  let [lizardClass,setLizardClass]=useState('v');
  let [spockClass,setSpockClass]=useState('d');
  let [stoneClass,setStoneClass]=useState('d');
  let [scissorsClass,setScissorsClass]=useState('d');
  let currContext = useContext(authContext)
  let pushFunc = () => {props.history.push('/lock')}
  let triggerAnimation=(classNameSet)=>{
    if(classNameSet===setPaperClass)
    props.setId(1);
    else if(classNameSet===setLizardClass)
    props.setId(3)
    else if(classNameSet===setSpockClass)
    props.setId(4)
    else if(classNameSet===setScissorsClass)
    props.setId(2)
    else if(classNameSet===setStoneClass)
    props.setId(0)
    classNameSet('animationClass'); 
    setTimeout(pushFunc,1000)
  }
  const logout=()=>{
    props.history.push('/');
    props.logoutHandler();
  ...
  return (
    // <Provider value={{passedIndex:passedIndex}}>
    <div class="back">
          ...
          >
            <g id="main">
              <path
                id="pent-dark"
                opacity="0.2"
                d="M342 127.5L148.5 261.953L222.41 479.5H461.59L535.5 261.953L342 127.501V127.5Z"
                stroke="black"
                stroke-width="15"
              />
              <path
              ...
              <g
                id="paper"
                onClick={(e) => triggerAnimation(setPaperClass)}
              >
                <g id="paper-outline" filter="url(#filter0_i)">
                  <path
                    id="Vector"
                    d="M511.5 342C545.903 342 576 316.52 576 282.5C576 248.48 545.903 223 511.5 223C477.097 223 447 248.48 447 282.5C447 316.52 477.097 342 511.5 342Z"
                    stroke="#280BDD"
                    stroke-width="25"
                  />
                </g>
              ...
              <g id="stone" onClick={(e) => triggerAnimation(setStoneClass)}>
                ...
                <path
                  id="stone-container"
                  d="M226 524.5C258.309 524.5 284.5 500.995 284.5 472C284.5 443.005 258.309 419.5 226 419.5C193.691 419.5 167.5 443.005 167.5 472C167.5 500.995 193.691 524.5 226 524.5Z"
                  fill="white"
                />
                <path
                  id={stoneClass}
                  d="M252.136 457.085C251.318 446.422 239.733 447.511 239.733 447.511C234.843 438.6 227.204 445.054 227.204 445.054C221.335 436.322 213.978 444.414 213.978 444.414C201.29 443 201.782 453.721 201.782 453.721C201.484 457.13 203.57 467.673 203.57 467.673C201.688 461.596 197.606 466.641 197.606 466.641C192.586 474.646 196.364 479.028 196.364 479.028C203.156 487.255 217.628 497.13 217.628 497.13C222.869 500.233 220.652 503 220.652 503L252.35 497.587L253.078 491.372C257.897 476.31 252.136 457.085 252.136 457.085Z"
                  fill="#3B4262"
                />
              </g>
              <g
                id="spock"
                onClick={(e) => triggerAnimation(setSpockClass)}
              >
                <g id="spock-outline" filter="url(#filter3_i)">
                  <path
                    id="Vector_4"
                    d="M148.5 331C182.903 331 213 305.52 213 271.5C213 237.48 182.903 212 148.5 212C114.097 212 84 237.48 84 271.5C84 305.52 114.097 331 148.5 331Z"
                    stroke="#1D8BC8"
                    stroke-width="25"
                  />
                </g>
